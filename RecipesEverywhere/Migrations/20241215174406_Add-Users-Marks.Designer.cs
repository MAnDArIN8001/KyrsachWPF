...
namespace RecepiesEverywhere.Migrations
{
    ...
    [Migration("20241215174406_Add-Users-Marks")]
    partial class AddUsersMarks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarkUser", b =>
                {
                    b.HasOne("RecepiesEverywhere.Models.Mark", null)
                        .WithMany()
                        .HasForeignKey("MarksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecepiesEverywhere.Models.User", null)
                        .WithMany()
